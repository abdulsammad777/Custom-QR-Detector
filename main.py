...
PATH_TO_CKPT = './model/detect.tflite'
...
while True:
    ...
    # imgHeight, imgWidth = frame_resized.shape[:2]
    ...
    i = 0 # Only get the first detection. which also has the highest confidence
    if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0)):
        ...
        frame_width = imW
        frame_height = imH
        frame_width_ratio = center[0] / frame_width
        frame_height_ratio = center[1] / frame_height
        x_move = Screen_Width * frame_width_ratio
        y_move = Screen_Height * frame_height_ratio
        # frame = cv2.flip(frame, 1)
